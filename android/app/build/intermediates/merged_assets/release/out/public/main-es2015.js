...
const routes = [
    {
        path: 'dashboard',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-bottom-nav-bottom-nav-module */ "pages-bottom-nav-bottom-nav-module").then(__webpack_require__.bind(null, /*! ./pages/bottom-nav/bottom-nav.module */ "./src/app/pages/bottom-nav/bottom-nav.module.ts")).then(m => m.BottomNavPageModule)
    },
    {
        path: '',
        redirectTo: 'login',
...
/* harmony import */ var src_providers_apihelper_apihelper__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/providers/apihelper/apihelper */ "./src/providers/apihelper/apihelper.ts");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, storage, navCtrl, provider, router) {
            ...
            this.storage.get('offline-user').then((val) => {
                ...
                if (val) {
                    ...
                    this.provider.UserLogin(val.username, val.password).subscribe(data => {
                        ...
                        // set header values
                        console.log(this.LoginReponse.token);
...
/* harmony import */ var _ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @ionic-native/native-storage/ngx */ "./node_modules/@ionic-native/native-storage/__ivy_ngcc__/ngx/index.js");
...
/* harmony import */ var _ionic_native_file_opener_ngx__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @ionic-native/file-opener/ngx */ "./node_modules/@ionic-native/file-opener/__ivy_ngcc__/ngx/index.js");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            { provide: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ErrorHandler"], useClass: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ErrorHandler"] },
            src_providers_apihelper_apihelper__WEBPACK_IMPORTED_MODULE_6__["ApihelperProvider"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ApihelperProvider", function() { return ApihelperProvider; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/*
  ...
  and Angular DI.
*/
let ApihelperProvider = class ApihelperProvider {
    constructor(http, toastCtrl, loadingCtrl, storage) {
        this.http = http;
    ...
    SetHeader(token, userid) {
        ...
        this.HeaderConfig = { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"](header) };
    ...
    //  Account details
    AccountsDetails(accountid, accounttype) {
        let postData = new FormData();
    ...
    SavePaymentINformation(accountid, accounttype, transaction_type, data) {
        let postData = new FormData();
        postData.append('account_id', accountid);
        postData.append('account_type', accounttype);
...
ApihelperProvider.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ToastController"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["LoadingController"] },
    { type: _ionic_storage__WEBPACK_IMPORTED_MODULE_4__["Storage"] }
];
ApihelperProvider = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
module.exports = __webpack_require__(/*! D:\devrising\src\main.ts */"./src/main.ts");
