...
import * as ɵngcc2 from './range-knob';
...
function Range_div_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("ionIncrease", function Range_div_8_Template_div_ionIncrease_0_listener() { ɵngcc0.ɵɵrestoreView(_r6); const ctx_r5 = ɵngcc0.ɵɵnextContext(); return ctx_r5._keyChg(true, true); })("ionDecrease", function Range_div_8_Template_div_ionDecrease_0_listener() { ɵngcc0.ɵɵrestoreView(_r6); const ctx_r7 = ɵngcc0.ɵɵnextContext(); return ctx_r7._keyChg(false, true); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
Range.ɵfac = function Range_Factory(t) { return new (t || Range)(ɵngcc0.ɵɵdirectiveInject(Form), ɵngcc0.ɵɵdirectiveInject(Haptic), ɵngcc0.ɵɵdirectiveInject(Item, 8), ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(Platform), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(DomController), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef)); };
Range.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: Range, selectors: [["ion-range"]], viewQuery: function Range_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [ɵngcc1.NgForOf, ɵngcc2.RangeKnob, ɵngcc1.NgIf], encapsulation: 2 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Range, [{
        type: Component,
        args: [{
                selector: 'ion-range',
    ...
    }], function () { return [{ type: Form }, { type: Haptic }, { type: Item, decorators: [{
                type: Optional
            }] }, { type: Config }, { type: Platform }, { type: ɵngcc0.ElementRef }, { type: Renderer }, { type: DomController }, { type: ɵngcc0.ChangeDetectorRef }]; }, { min: [{
            type: Input
        }], max: [{
            type: Input
        }], step: [{
