...
RadioGroup.ɵfac = function RadioGroup_Factory(t) { return new (t || RadioGroup)(ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef)); };
RadioGroup.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: RadioGroup, selectors: [["", "radio-group", ""]], contentQueries: function RadioGroup_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, ListHeader, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._header = _t.first);
    } }, hostAttrs: ["role", "radiogroup"], inputs: { disabled: "disabled" }, outputs: { ionChange: "ionChange" }, features: [ɵngcc0.ɵɵProvidersFeature([{ provide: NG_VALUE_ACCESSOR, useExisting: RadioGroup, multi: true }])] });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(RadioGroup, [{
        type: Directive,
        args: [{
    ...
    }], function () { return [{ type: Renderer }, { type: ɵngcc0.ElementRef }, { type: ɵngcc0.ChangeDetectorRef }]; }, { ionChange: [{
            type: Output
        }], disabled: [{
            type: Input
        }], _header: [{
