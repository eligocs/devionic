...
ToolbarTitle.ɵfac = function ToolbarTitle_Factory(t) { return new (t || ToolbarTitle)(ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(Toolbar, 8), ɵngcc0.ɵɵdirectiveInject(forwardRef(() => Navbar), 8)); };
ToolbarTitle.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ToolbarTitle, selectors: [["ion-title"]], features: [ɵngcc0.ɵɵInheritDefinitionFeature], ngContentSelectors: _c0, decls: 2, vars: 1, consts: [[1, "toolbar-title", 3, "ngClass"]], template: function ToolbarTitle_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ToolbarTitle, [{
        type: Component,
        args: [{
                selector: 'ion-title',
    ...
    }], function () { return [{ type: Config }, { type: ɵngcc0.ElementRef }, { type: Renderer }, { type: Toolbar, decorators: [{
                type: Optional
            }] }, { type: Navbar, decorators: [{
                type: Optional
            }, {
                type: Inject,
