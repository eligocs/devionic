...
import * as ɵngcc1 from '../backdrop/backdrop';
...
function AlertCmp_div_6_ng_template_1_button_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function AlertCmp_div_6_ng_template_1_button_1_Template_button_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r10); const i_r8 = ctx.$implicit; const ctx_r9 = ɵngcc0.ɵɵnextContext(3); return ctx_r9.rbClick(i_r8); });
...
function AlertCmp_div_6_ng_template_2_button_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function AlertCmp_div_6_ng_template_2_button_1_Template_button_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r14); const i_r12 = ctx.$implicit; const ctx_r13 = ɵngcc0.ɵɵnextContext(3); return ctx_r13.cbClick(i_r12); });
...
function AlertCmp_div_6_ng_template_3_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("ngModelChange", function AlertCmp_div_6_ng_template_3_div_1_Template_input_ngModelChange_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r18); const i_r16 = ctx.$implicit; return i_r16.value = $event; });
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function AlertCmp_button_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function AlertCmp_button_8_Template_button_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r21); const b_r19 = ctx.$implicit; const ctx_r20 = ɵngcc0.ɵɵnextContext(); return ctx_r20.btnClick(b_r19); });
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
AlertCmp.ɵfac = function AlertCmp_Factory(t) { return new (t || AlertCmp)(ɵngcc0.ɵɵdirectiveInject(ViewController), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(GestureController), ɵngcc0.ɵɵdirectiveInject(NavParams), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(Platform)); };
AlertCmp.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: AlertCmp, selectors: [["ion-alert"]], hostAttrs: ["role", "dialog"], hostVars: 2, hostBindings: function AlertCmp_HostBindings(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [ɵngcc1.Backdrop, ɵngcc2.NgIf, ɵngcc2.NgClass, ɵngcc2.NgForOf, ɵngcc2.NgSwitch, ɵngcc2.NgSwitchCase, ɵngcc2.NgSwitchDefault, ɵngcc3.Button, ɵngcc4.DefaultValueAccessor, ɵngcc4.NgControlStatus, ɵngcc4.NgModel], encapsulation: 2 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(AlertCmp, [{
        type: Component,
        args: [{
                selector: 'ion-alert',
    ...
    }], function () { return [{ type: ViewController }, { type: ɵngcc0.ElementRef }, { type: Config }, { type: GestureController }, { type: NavParams }, { type: Renderer }, { type: Platform }]; }, { keyUp: [{
            type: HostListener,
