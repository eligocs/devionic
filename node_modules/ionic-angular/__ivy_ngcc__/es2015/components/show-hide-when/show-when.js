...
ShowWhen.ɵfac = function ShowWhen_Factory(t) { return new (t || ShowWhen)(ɵngcc0.ɵɵinjectAttribute('showWhen'), ɵngcc0.ɵɵdirectiveInject(Platform), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone)); };
ShowWhen.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ShowWhen, selectors: [["", "showWhen", ""]], hostVars: 2, hostBindings: function ShowWhen_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵclassProp("hidden-show-when", !ctx.isMatch);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ShowWhen, [{
        type: Directive,
        args: [{
                selector: '[showWhen]',
                host: {
                ...
                type: Attribute,
                args: ['showWhen']
            }] }, { type: Platform }, { type: ɵngcc0.NgZone }]; }, null); })();
