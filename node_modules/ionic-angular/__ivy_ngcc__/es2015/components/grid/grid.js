...
Grid.ɵfac = function Grid_Factory(t) { return new (t || Grid)(); };
Grid.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: Grid, selectors: [["ion-grid"], ["", "ion-grid", ""]], hostAttrs: [1, "grid"] });
/** @nocollapse */
Grid.ctorParameters = () => [];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Grid, [{
        type: Directive,
        args: [{
