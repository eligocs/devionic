...
Row.ɵfac = function Row_Factory(t) { return new (t || Row)(); };
Row.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: Row, selectors: [["ion-row"], ["", "ion-row", ""]], hostAttrs: [1, "row"] });
/** @nocollapse */
Row.ctorParameters = () => [];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Row, [{
        type: Directive,
        args: [{
