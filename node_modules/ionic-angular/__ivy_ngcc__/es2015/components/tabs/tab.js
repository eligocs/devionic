...
Tab.ɵfac = function Tab_Factory(t) { return new (t || Tab)(ɵngcc0.ɵɵdirectiveInject(Tabs), ɵngcc0.ɵɵdirectiveInject(App), ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(Platform), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ComponentFactoryResolver), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(GestureController), ɵngcc0.ɵɵdirectiveInject(TransitionController), ɵngcc0.ɵɵdirectiveInject(DeepLinker, 8), ɵngcc0.ɵɵdirectiveInject(DomController), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ErrorHandler)); };
Tab.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: Tab, selectors: [["ion-tab"]], viewQuery: function Tab_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, true, ViewContainerRef);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._vp = _t.first);
    } }, hostAttrs: ["role", "tabpanel"], hostVars: 2, hostBindings: function Tab_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵattribute("id", ctx._tabId)("aria-labelledby", ctx._btnId);
    } }, inputs: { enabled: "enabled", show: "show", tabsHideOnSubPages: "tabsHideOnSubPages", tabBadgeStyle: "tabBadgeStyle", root: "root", rootParams: "rootParams", tabUrlPath: "tabUrlPath", tabTitle: "tabTitle", tabIcon: "tabIcon", tabBadge: "tabBadge" }, outputs: { ionSelect: "ionSelect" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature], decls: 3, vars: 0, consts: [["viewport", ""], [1, "nav-decor"]], template: function Tab_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Tab, [{
        type: Component,
        args: [{
                selector: 'ion-tab',
    ...
    }], function () { return [{ type: Tabs }, { type: App }, { type: Config }, { type: Platform }, { type: ɵngcc0.ElementRef }, { type: ɵngcc0.NgZone }, { type: Renderer }, { type: ɵngcc0.ComponentFactoryResolver }, { type: ɵngcc0.ChangeDetectorRef }, { type: GestureController }, { type: TransitionController }, { type: DeepLinker, decorators: [{
                type: Optional
            }] }, { type: DomController }, { type: ɵngcc0.ErrorHandler }]; }, { ionSelect: [{
            type: Output
        }], enabled: [{
            type: Input
        }], show: [{
