...
TabButton.ɵfac = function TabButton_Factory(t) { return new (t || TabButton)(ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer)); };
TabButton.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: TabButton, selectors: [["", 8, "tab-button"]], hostVars: 19, hostBindings: function TabButton_HostBindings(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [ɵngcc1.NgIf, ɵngcc2.Icon, ɵngcc3.Badge], encapsulation: 2 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(TabButton, [{
        type: Component,
        args: [{
                selector: '.tab-button',
    ...
    }], function () { return [{ type: Config }, { type: ɵngcc0.ElementRef }, { type: Renderer }]; }, { ionSelect: [{
            type: Output
        }], onClick: [{
            type: HostListener,
            args: ['click']
