...
import * as ɵngcc2 from './tab-highlight';
import * as ɵngcc3 from './tab-button';

const _c0 = ["tabbar"];
const _c1 = ["portal"];
function Tabs_a_2_Template(rf, ctx) { if (rf & 1) {
    const _r5 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "a", 6);
    ɵngcc0.ɵɵlistener("ionSelect", function Tabs_a_2_Template_a_ionSelect_0_listener() { ɵngcc0.ɵɵrestoreView(_r5); const t_r3 = ctx.$implicit; const ctx_r4 = ɵngcc0.ɵɵnextContext(); return ctx_r4.select(t_r3); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const t_r3 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("tab", t_r3);
} }
const _c2 = ["*"];
...
Tabs.ɵfac = function Tabs_Factory(t) { return new (t || Tabs)(ɵngcc0.ɵɵdirectiveInject(NavController, 8), ɵngcc0.ɵɵdirectiveInject(ViewController, 8), ɵngcc0.ɵɵdirectiveInject(App), ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Platform), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(DeepLinker), ɵngcc0.ɵɵdirectiveInject(Keyboard)); };
Tabs.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: Tabs, selectors: [["ion-tabs"]], viewQuery: function Tabs_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(TabHighlight, true);
        ɵngcc0.ɵɵviewQuery(_c0, true);
        ɵngcc0.ɵɵviewQuery(_c1, true, ViewContainerRef);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._highlight = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._tabbar = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.portal = _t.first);
    } }, inputs: { tabsHighlight: "tabsHighlight", name: "name", selectedIndex: "selectedIndex", tabsLayout: "tabsLayout", tabsPlacement: "tabsPlacement" }, outputs: { ionChange: "ionChange" }, features: [ɵngcc0.ɵɵProvidersFeature([{ provide: RootNode, useExisting: forwardRef(() => Tabs) }]), ɵngcc0.ɵɵInheritDefinitionFeature], ngContentSelectors: _c2, decls: 7, vars: 1, consts: [["role", "tablist", 1, "tabbar"], ["tabbar", ""], ["class", "tab-button", "role", "tab", "href", "#", 3, "tab", "ionSelect", 4, "ngFor", "ngForOf"], [1, "tab-highlight"], ["tab-portal", ""], ["portal", ""], ["role", "tab", "href", "#", 1, "tab-button", 3, "tab", "ionSelect"]], template: function Tabs_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef();
        ɵngcc0.ɵɵelementStart(0, "div", 0, 1);
        ɵngcc0.ɵɵtemplate(2, Tabs_a_2_Template, 1, 1, "a", 2);
    ...
    } }, directives: [ɵngcc1.NgForOf, ɵngcc2.TabHighlight, ɵngcc3.TabButton], encapsulation: 2 });
/** @nocollapse */
Tabs.ctorParameters = () => [
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Tabs, [{
        type: Component,
        args: [{
                selector: 'ion-tabs',
    ...
    }], function () { return [{ type: NavController, decorators: [{
                type: Optional
            }] }, { type: ViewController, decorators: [{
                type: Optional
            }] }, { type: App }, { type: Config }, { type: ɵngcc0.ElementRef }, { type: Platform }, { type: Renderer }, { type: DeepLinker }, { type: Keyboard }]; }, { ionChange: [{
            type: Output
        }], tabsHighlight: [{
            type: Input
        }], name: [{
