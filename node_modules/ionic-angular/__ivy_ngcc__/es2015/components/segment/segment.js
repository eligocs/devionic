...
Segment.ɵfac = function Segment_Factory(t) { return new (t || Segment)(ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.NgControl, 8)); };
Segment.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: Segment, selectors: [["ion-segment"]], contentQueries: function Segment_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, SegmentButton, false);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._buttons = _t);
    } }, hostVars: 2, hostBindings: function Segment_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵclassProp("segment-disabled", ctx._disabled);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Segment, [{
        type: Directive,
        args: [{
    ...
    }], function () { return [{ type: Config }, { type: ɵngcc0.ElementRef }, { type: Renderer }, { type: ɵngcc1.NgControl, decorators: [{
                type: Optional
            }] }]; }, { _buttons: [{
