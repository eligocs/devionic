...
Icon.ɵfac = function Icon_Factory(t) { return new (t || Icon)(ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer)); };
Icon.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: Icon, selectors: [["ion-icon"]], hostAttrs: ["role", "img"], hostVars: 2, hostBindings: function Icon_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵclassProp("hide", ctx._hidden);
    } }, inputs: { name: "name", ios: "ios", md: "md", isActive: "isActive" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/** @nocollapse */
Icon.ctorParameters = () => [
    { type: Config, },
    { type: ElementRef, },
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Icon, [{
        type: Directive,
        args: [{
                selector: 'ion-icon',
                host: {
    ...
    }], function () { return [{ type: Config }, { type: ɵngcc0.ElementRef }, { type: Renderer }]; }, { _hidden: [{
            type: HostBinding,
            args: ['class.hide']
        }], name: [{
            type: Input
