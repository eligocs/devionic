...
const _c0 = ["fixedContent"];
const _c1 = ["scrollContent"];
const _c2 = [[["", "ion-fixed", ""], ["ion-fab"]], "*", [["ion-refresher"]]];
const _c3 = ["[ion-fixed],ion-fab", "*", "ion-refresher"];
...
Content.ɵfac = function Content_Factory(t) { return new (t || Content)(ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(Platform), ɵngcc0.ɵɵdirectiveInject(DomController), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(App), ɵngcc0.ɵɵdirectiveInject(Keyboard), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(ViewController, 8), ɵngcc0.ɵɵdirectiveInject(NavController, 8)); };
Content.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: Content, selectors: [["ion-content"]], viewQuery: function Content_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, true, ElementRef);
        ɵngcc0.ɵɵviewQuery(_c1, true, ElementRef);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._fixedContent = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._scrollContent = _t.first);
    } }, hostVars: 4, hostBindings: function Content_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵclassProp("statusbar-padding", ctx.statusbarPadding)("has-refresher", ctx._hasRefresher);
    } }, inputs: { fullscreen: "fullscreen", scrollDownOnLoad: "scrollDownOnLoad" }, outputs: { ionScrollStart: "ionScrollStart", ionScroll: "ionScroll", ionScrollEnd: "ionScrollEnd" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature], ngContentSelectors: _c3, decls: 7, vars: 0, consts: [[1, "fixed-content"], ["fixedContent", ""], [1, "scroll-content"], ["scrollContent", ""]], template: function Content_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Content, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: Config }, { type: Platform }, { type: DomController }, { type: ɵngcc0.ElementRef }, { type: Renderer }, { type: App }, { type: Keyboard }, { type: ɵngcc0.NgZone }, { type: ViewController, decorators: [{
                type: Optional
            }] }, { type: NavController, decorators: [{
                type: Optional
            }] }]; }, { ionScrollStart: [{
            type: Output
        }], ionScroll: [{
            ...
            type: ViewChild,
            args: ['fixedContent', { read: ElementRef }]
        }], _scrollContent: [{
            type: ViewChild,
