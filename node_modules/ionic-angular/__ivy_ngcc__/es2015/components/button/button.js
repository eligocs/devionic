...
Button.ɵfac = function Button_Factory(t) { return new (t || Button)(ɵngcc0.ɵɵinjectAttribute('ion-button'), ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer)); };
Button.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: Button, selectors: [["", "ion-button", ""]], inputs: { large: "large", small: "small", default: "default", outline: "outline", clear: "clear", solid: "solid", round: "round", block: "block", full: "full", strong: "strong", mode: "mode", color: "color" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature], attrs: _c0, ngContentSelectors: _c1, decls: 3, vars: 0, consts: [[1, "button-inner"], [1, "button-effect"]], template: function Button_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Button, [{
        ...
        args: [{
                ...
                type: Attribute,
                args: ['ion-button']
            }] }, { type: Config }, { type: ɵngcc0.ElementRef }, { type: Renderer }]; }, { large: [{
            type: Input
        }], small: [{
            type: Input
        }], default: [{
