...
SplitPane.ɵfac = function SplitPane_Factory(t) { return new (t || SplitPane)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(Platform), ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer)); };
SplitPane.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: SplitPane, selectors: [["ion-split-pane"]], contentQueries: function SplitPane_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, RootNode, false);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._setchildren = _t);
    } }, inputs: { when: "when", enabled: "enabled" }, outputs: { ionChange: "ionChange" }, features: [ɵngcc0.ɵɵProvidersFeature([{ provide: RootNode, useExisting: forwardRef(() => SplitPane) }]), ɵngcc0.ɵɵInheritDefinitionFeature] });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SplitPane, [{
        type: Directive,
        args: [{
                selector: 'ion-split-pane',
                providers: [{ provide: RootNode, useExisting: forwardRef(() => SplitPane) }]
            }]
    }], function () { return [{ type: ɵngcc0.NgZone }, { type: Platform }, { type: Config }, { type: ɵngcc0.ElementRef }, { type: Renderer }]; }, { ionChange: [{
            type: Output
        }], _setchildren: [{
            type: ContentChildren,
            args: [RootNode, { descendants: false }]
        }], when: [{
            type: Input
        }], enabled: [{
            type: Input
