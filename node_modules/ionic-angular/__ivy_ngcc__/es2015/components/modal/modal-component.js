...
ModalCmp.ɵfac = function ModalCmp_Factory(t) { return new (t || ModalCmp)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ComponentFactoryResolver), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(NavParams), ɵngcc0.ɵɵdirectiveInject(ViewController), ɵngcc0.ɵɵdirectiveInject(GestureController), ɵngcc0.ɵɵdirectiveInject(ModuleLoader)); };
ModalCmp.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ModalCmp, selectors: [["ion-modal"]], viewQuery: function ModalCmp_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, true, ViewContainerRef);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._viewport = _t.first);
    } }, hostBindings: function ModalCmp_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("keyup", function ModalCmp_keyup_HostBindingHandler($event) { return ctx._keyUp($event); }, false, ɵngcc0.ɵɵresolveBody);
    } }, decls: 4, vars: 2, consts: [[3, "click"], [1, "modal-wrapper"], ["nav-viewport", ""], ["viewport", ""]], template: function ModalCmp_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelementStart(0, "ion-backdrop", 0);
        ɵngcc0.ɵɵlistener("click", function ModalCmp_Template_ion_backdrop_click_0_listener() { return ctx._bdClick(); });
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementStart(1, "div", 1);
        ɵngcc0.ɵɵelement(2, "div", 2, 3);
        ɵngcc0.ɵɵelementEnd();
    } if (rf & 2) {
        ɵngcc0.ɵɵclassProp("backdrop-no-tappable", !ctx._bdDismiss);
    } }, directives: [ɵngcc1.Backdrop], encapsulation: 2 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ModalCmp, [{
        type: Component,
        args: [{
                selector: 'ion-modal',
    ...
    }], function () { return [{ type: ɵngcc0.ComponentFactoryResolver }, { type: Renderer }, { type: ɵngcc0.ElementRef }, { type: NavParams }, { type: ViewController }, { type: GestureController }, { type: ModuleLoader }]; }, { _keyUp: [{
            type: HostListener,
