...
Refresher.ɵfac = function Refresher_Factory(t) { return new (t || Refresher)(ɵngcc0.ɵɵdirectiveInject(Platform), ɵngcc0.ɵɵdirectiveInject(Content, 1), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(GestureController)); };
Refresher.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: Refresher, selectors: [["ion-refresher"]], hostVars: 4, hostBindings: function Refresher_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵstyleProp("top", ctx._top);
        ɵngcc0.ɵɵclassProp("refresher-active", ctx.state !== "inactive");
    } }, inputs: { pullMin: "pullMin", pullMax: "pullMax", closeDuration: "closeDuration", snapbackDuration: "snapbackDuration", enabled: "enabled" }, outputs: { ionRefresh: "ionRefresh", ionPull: "ionPull", ionStart: "ionStart" } });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Refresher, [{
        type: Directive,
        args: [{
    ...
    }], function () { return [{ type: Platform }, { type: Content, decorators: [{
                type: Host
            }] }, { type: ɵngcc0.NgZone }, { type: GestureController }]; }, { pullMin: [{
            type: Input
        }], pullMax: [{
            type: Input
        }], closeDuration: [{
