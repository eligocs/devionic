...
RefresherContent.ɵfac = function RefresherContent_Factory(t) { return new (t || RefresherContent)(ɵngcc0.ɵɵdirectiveInject(Refresher), ɵngcc0.ɵɵdirectiveInject(Config)); };
RefresherContent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: RefresherContent, selectors: [["ion-refresher-content"]], hostVars: 1, hostBindings: function RefresherContent_HostBindings(rf, ctx) { if (rf & 2) {
    ...
    } }, directives: [ɵngcc1.NgIf, ɵngcc2.Spinner, ɵngcc3.Icon], encapsulation: 2 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(RefresherContent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: Refresher }, { type: Config }]; }, { pullingIcon: [{
            type: Input
        }], refreshingSpinner: [{
            type: Input
        }], pullingText: [{
