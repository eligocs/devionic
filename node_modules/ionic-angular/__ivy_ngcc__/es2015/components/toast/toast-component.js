...
function ToastCmp_button_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ToastCmp_button_3_Template_button_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r3); const ctx_r2 = ɵngcc0.ɵɵnextContext(); return ctx_r2.cbClick(); });
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
ToastCmp.ɵfac = function ToastCmp_Factory(t) { return new (t || ToastCmp)(ɵngcc0.ɵɵdirectiveInject(ViewController), ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(NavParams), ɵngcc0.ɵɵdirectiveInject(Renderer)); };
ToastCmp.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ToastCmp, selectors: [["ion-toast"]], hostAttrs: ["role", "dialog"], hostVars: 2, hostBindings: function ToastCmp_HostBindings(rf, ctx) { if (rf & 2) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ToastCmp, [{
        type: Component,
        args: [{
                selector: 'ion-toast',
    ...
    }], function () { return [{ type: ViewController }, { type: Config }, { type: ɵngcc0.ElementRef }, { type: NavParams }, { type: Renderer }]; }, null); })();
let toastIds = -1;
