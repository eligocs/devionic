...
function DateTime_div_0_Template(rf, ctx) { if (rf & 1) {
...
function DateTime_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r1._text);
} }
...
DateTime.ɵfac = function DateTime_Factory(t) { return new (t || DateTime)(ɵngcc0.ɵɵdirectiveInject(Form), ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(Item, 8), ɵngcc0.ɵɵdirectiveInject(PickerController, 8)); };
DateTime.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DateTime, selectors: [["ion-datetime"]], hostVars: 2, hostBindings: function DateTime_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("click", function DateTime_click_HostBindingHandler($event) { return ctx._click($event); })("keyup.space", function DateTime_keyup_space_HostBindingHandler() { return ctx._keyup(); });
    } if (rf & 2) {
        ɵngcc0.ɵɵclassProp("datetime-disabled", ctx._disabled);
    } }, inputs: { cancelText: "cancelText", doneText: "doneText", pickerOptions: "pickerOptions", placeholder: "placeholder", min: "min", max: "max", displayFormat: "displayFormat", initialValue: "initialValue", pickerFormat: "pickerFormat", yearValues: "yearValues", monthValues: "monthValues", dayValues: "dayValues", hourValues: "hourValues", minuteValues: "minuteValues", monthNames: "monthNames", monthShortNames: "monthShortNames", dayNames: "dayNames", dayShortNames: "dayShortNames" }, outputs: { ionCancel: "ionCancel" }, features: [ɵngcc0.ɵɵProvidersFeature([{ provide: NG_VALUE_ACCESSOR, useExisting: DateTime, multi: true }]), ɵngcc0.ɵɵInheritDefinitionFeature], decls: 3, vars: 5, consts: [["class", "datetime-text datetime-placeholder", 4, "ngIf"], ["class", "datetime-text", 4, "ngIf"], ["aria-haspopup", "true", "type", "button", "ion-button", "item-cover", 1, "item-cover", 3, "id"], [1, "datetime-text", "datetime-placeholder"], [1, "datetime-text"]], template: function DateTime_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, DateTime_div_0_Template, 2, 1, "div", 0);
        ɵngcc0.ɵɵtemplate(1, DateTime_div_1_Template, 2, 1, "div", 1);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DateTime, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: Form }, { type: Config }, { type: ɵngcc0.ElementRef }, { type: Renderer }, { type: Item, decorators: [{
                type: Optional
            }] }, { type: PickerController, decorators: [{
                type: Optional
            }] }]; }, { cancelText: [{
            type: Input
        }], doneText: [{
