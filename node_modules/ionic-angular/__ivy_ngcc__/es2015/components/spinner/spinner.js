...
function Spinner__svg_svg_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵnamespaceSVG();
    ɵngcc0.ɵɵelementStart(0, "svg", 1);
    ɵngcc0.ɵɵelement(1, "circle", 2);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const i_r2 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngStyle", i_r2.style);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵattribute("r", i_r2.r);
} }
function Spinner__svg_svg_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵnamespaceSVG();
    ɵngcc0.ɵɵelementStart(0, "svg", 1);
    ɵngcc0.ɵɵelement(1, "line", 2);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const i_r3 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngStyle", i_r3.style);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵattribute("y1", i_r3.y1)("y2", i_r3.y2);
} }
...
Spinner.ɵfac = function Spinner_Factory(t) { return new (t || Spinner)(ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer)); };
Spinner.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: Spinner, selectors: [["ion-spinner"]], hostVars: 2, hostBindings: function Spinner_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵclassProp("spinner-paused", ctx._paused);
    } }, inputs: { name: "name", duration: "duration", paused: "paused" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature], decls: 2, vars: 2, consts: [["viewBox", "0 0 64 64", 3, "ngStyle", 4, "ngFor", "ngForOf"], ["viewBox", "0 0 64 64", 3, "ngStyle"], ["transform", "translate(32,32)"]], template: function Spinner_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, Spinner__svg_svg_0_Template, 2, 2, "svg", 0);
        ɵngcc0.ɵɵtemplate(1, Spinner__svg_svg_1_Template, 2, 3, "svg", 0);
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("ngForOf", ctx._c);
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngForOf", ctx._l);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Spinner, [{
    ...
    }], function () { return [{ type: Config }, { type: ɵngcc0.ElementRef }, { type: Renderer }]; }, { name: [{
            type: Input
        }], duration: [{
            type: Input
        }], paused: [{
