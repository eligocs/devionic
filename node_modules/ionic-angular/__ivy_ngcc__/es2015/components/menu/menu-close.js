...
MenuClose.ɵfac = function MenuClose_Factory(t) { return new (t || MenuClose)(ɵngcc0.ɵɵdirectiveInject(MenuController)); };
MenuClose.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: MenuClose, selectors: [["", "menuClose", ""]], hostBindings: function MenuClose_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("click", function MenuClose_click_HostBindingHandler() { return ctx.close(); });
    } }, inputs: { menuClose: "menuClose" } });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MenuClose, [{
        type: Directive,
        args: [{
                selector: '[menuClose]'
            }]
    }], function () { return [{ type: MenuController }]; }, { close: [{
            type: HostListener,
            args: ['click']
        }], menuClose: [{
            type: Input
