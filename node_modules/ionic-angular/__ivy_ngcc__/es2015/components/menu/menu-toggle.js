...
MenuToggle.ɵfac = function MenuToggle_Factory(t) { return new (t || MenuToggle)(ɵngcc0.ɵɵdirectiveInject(MenuController), ɵngcc0.ɵɵdirectiveInject(ViewController, 8), ɵngcc0.ɵɵdirectiveInject(Button, 8), ɵngcc0.ɵɵdirectiveInject(Navbar, 8)); };
MenuToggle.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: MenuToggle, selectors: [["", "menuToggle", ""]], hostVars: 1, hostBindings: function MenuToggle_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("click", function MenuToggle_click_HostBindingHandler() { return ctx.toggle(); });
    } if (rf & 2) {
        ɵngcc0.ɵɵhostProperty("hidden", ctx.isHidden);
    } }, inputs: { menuToggle: "menuToggle" } });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MenuToggle, [{
        type: Directive,
        args: [{
                selector: '[menuToggle]',
                host: {
    ...
    }], function () { return [{ type: MenuController }, { type: ViewController, decorators: [{
                type: Optional
            }] }, { type: Button, decorators: [{
                type: Optional
