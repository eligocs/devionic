...
Menu.ɵfac = function Menu_Factory(t) { return new (t || Menu)(ɵngcc0.ɵɵdirectiveInject(MenuController), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(Platform), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(Keyboard), ɵngcc0.ɵɵdirectiveInject(GestureController), ɵngcc0.ɵɵdirectiveInject(DomController), ɵngcc0.ɵɵdirectiveInject(App)); };
Menu.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: Menu, selectors: [["ion-menu"]], contentQueries: function Menu_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, Content, true);
        ɵngcc0.ɵɵcontentQuery(dirIndex, Nav, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.menuContent = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.menuNav = _t.first);
    } }, viewQuery: function Menu_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(Backdrop, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.backdrop = _t.first);
    } }, hostAttrs: ["role", "navigation"], inputs: { side: "side", enabled: "enabled", swipeEnabled: "swipeEnabled", persistent: "persistent", type: "type", content: "content", id: "id", maxEdgeStart: "maxEdgeStart" }, outputs: { ionDrag: "ionDrag", ionOpen: "ionOpen", ionClose: "ionClose" }, features: [ɵngcc0.ɵɵProvidersFeature([{ provide: RootNode, useExisting: forwardRef(() => Menu) }])], ngContentSelectors: _c0, decls: 3, vars: 0, consts: [[1, "menu-inner"]], template: function Menu_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef();
        ɵngcc0.ɵɵelementStart(0, "div", 0);
        ɵngcc0.ɵɵprojection(1);
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelement(2, "ion-backdrop");
    } }, directives: [ɵngcc1.Backdrop], encapsulation: 2, changeDetection: 0 });
/** @nocollapse */
Menu.ctorParameters = () => [
    { type: MenuController, },
    { type: ElementRef, },
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Menu, [{
    ...
    }], function () { return [{ type: MenuController }, { type: ɵngcc0.ElementRef }, { type: Config }, { type: Platform }, { type: Renderer }, { type: Keyboard }, { type: GestureController }, { type: DomController }, { type: App }]; }, { ionDrag: [{
            type: Output
        }], ionOpen: [{
            type: Output
        }], ionClose: [{
