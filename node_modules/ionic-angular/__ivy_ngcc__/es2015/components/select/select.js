...
function Select_div_0_Template(rf, ctx) { if (rf & 1) {
...
function Select_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r1.selectedText || ctx_r1._text);
} }
...
Select.ɵfac = function Select_Factory(t) { return new (t || Select)(ɵngcc0.ɵɵdirectiveInject(App), ɵngcc0.ɵɵdirectiveInject(Form), ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(Item, 8), ɵngcc0.ɵɵdirectiveInject(DeepLinker)); };
Select.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: Select, selectors: [["ion-select"]], contentQueries: function Select_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, Option, false);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.options = _t);
    } }, hostVars: 2, hostBindings: function Select_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("click", function Select_click_HostBindingHandler($event) { return ctx._click($event); })("keyup.space", function Select_keyup_space_HostBindingHandler() { return ctx._keyup(); });
    } if (rf & 2) {
        ɵngcc0.ɵɵclassProp("select-disabled", ctx._disabled);
    } }, inputs: { cancelText: "cancelText", okText: "okText", selectOptions: "selectOptions", interface: "interface", selectedText: "selectedText", compareWith: "compareWith", multiple: "multiple", placeholder: "placeholder" }, outputs: { ionCancel: "ionCancel" }, features: [ɵngcc0.ɵɵProvidersFeature([{ provide: NG_VALUE_ACCESSOR, useExisting: Select, multi: true }]), ɵngcc0.ɵɵInheritDefinitionFeature], decls: 5, vars: 5, consts: [["class", "select-placeholder select-text", 4, "ngIf"], ["class", "select-text", 4, "ngIf"], [1, "select-icon"], [1, "select-icon-inner"], ["aria-haspopup", "true", "type", "button", "ion-button", "item-cover", 1, "item-cover", 3, "id"], [1, "select-placeholder", "select-text"], [1, "select-text"]], template: function Select_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, Select_div_0_Template, 2, 1, "div", 0);
        ɵngcc0.ɵɵtemplate(1, Select_div_1_Template, 2, 1, "div", 1);
        ɵngcc0.ɵɵelementStart(2, "div", 2);
        ɵngcc0.ɵɵelement(3, "div", 3);
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelement(4, "button", 4);
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("ngIf", !ctx._text);
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngIf", ctx._text);
        ɵngcc0.ɵɵadvance(3);
        ɵngcc0.ɵɵproperty("id", ctx.id);
        ɵngcc0.ɵɵattribute("aria-labelledby", ctx._labelId)("aria-disabled", ctx._disabled);
    } }, directives: [ɵngcc1.NgIf, ɵngcc2.Button], encapsulation: 2 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Select, [{
        type: Component,
        args: [{
                selector: 'ion-select',
    ...
    }], function () { return [{ type: App }, { type: Form }, { type: Config }, { type: ɵngcc0.ElementRef }, { type: Renderer }, { type: Item, decorators: [{
                type: Optional
            }] }, { type: DeepLinker }]; }, { cancelText: [{
            type: Input
        }], okText: [{
            type: Input
        }], selectOptions: [{
