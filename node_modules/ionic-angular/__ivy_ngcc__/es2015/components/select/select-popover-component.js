...
SelectPopover.ɵfac = function SelectPopover_Factory(t) { return new (t || SelectPopover)(ɵngcc0.ɵɵdirectiveInject(NavParams), ɵngcc0.ɵɵdirectiveInject(ViewController)); };
SelectPopover.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: SelectPopover, selectors: [["ng-component"]], decls: 2, vars: 2, consts: [["radio-group", "", 3, "ngModel", "ngModelChange"], [4, "ngFor", "ngForOf"], [3, "checked", "value", "disabled"]], template: function SelectPopover_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [ɵngcc1.List, ɵngcc2.RadioGroup, ɵngcc3.NgControlStatus, ɵngcc3.NgModel, ɵngcc4.NgForOf, ɵngcc5.Item, ɵngcc6.ItemContent, ɵngcc7.Label, ɵngcc8.RadioButton], encapsulation: 2 });
/** @nocollapse */
SelectPopover.ctorParameters = () => [
    { type: NavParams, },
    { type: ViewController, },
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SelectPopover, [{
        type: Component,
        args: [{
                template: `
  ...
  `
    ...
    }], function () { return [{ type: NavParams }, { type: ViewController }]; }, null); })();
