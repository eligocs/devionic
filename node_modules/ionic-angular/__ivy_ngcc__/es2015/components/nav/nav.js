...
Nav.ɵfac = function Nav_Factory(t) { return new (t || Nav)(ɵngcc0.ɵɵdirectiveInject(ViewController, 8), ɵngcc0.ɵɵdirectiveInject(NavController, 8), ɵngcc0.ɵɵdirectiveInject(App), ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(Platform), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ComponentFactoryResolver), ɵngcc0.ɵɵdirectiveInject(GestureController), ɵngcc0.ɵɵdirectiveInject(TransitionController), ɵngcc0.ɵɵdirectiveInject(DeepLinker, 8), ɵngcc0.ɵɵdirectiveInject(DomController), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ErrorHandler)); };
Nav.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: Nav, selectors: [["ion-nav"]], viewQuery: function Nav_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, true, ViewContainerRef);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._vp = _t.first);
    } }, inputs: { root: "root", rootParams: "rootParams", name: "name" }, features: [ɵngcc0.ɵɵProvidersFeature([{ provide: RootNode, useExisting: forwardRef(() => Nav) }]), ɵngcc0.ɵɵInheritDefinitionFeature], decls: 3, vars: 0, consts: [["nav-viewport", ""], ["viewport", ""], [1, "nav-decor"]], template: function Nav_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Nav, [{
        type: Component,
        args: [{
                selector: 'ion-nav',
    ...
    }], function () { return [{ type: ViewController, decorators: [{
                type: Optional
            }] }, { type: NavController, decorators: [{
                type: Optional
            }] }, { type: App }, { type: Config }, { type: Platform }, { type: ɵngcc0.ElementRef }, { type: ɵngcc0.NgZone }, { type: Renderer }, { type: ɵngcc0.ComponentFactoryResolver }, { type: GestureController }, { type: TransitionController }, { type: DeepLinker, decorators: [{
                type: Optional
            }] }, { type: DomController }, { type: ɵngcc0.ErrorHandler }]; }, { _vp: [{
            type: ViewChild,
