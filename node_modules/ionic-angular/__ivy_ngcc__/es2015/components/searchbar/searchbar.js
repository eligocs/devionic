...
Searchbar.ɵfac = function Searchbar_Factory(t) { return new (t || Searchbar)(ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(Platform), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.NgControl, 8)); };
Searchbar.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: Searchbar, selectors: [["ion-searchbar"]], viewQuery: function Searchbar_Query(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("tabindex", ctx._isActive ? 1 : 0 - 1);
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵtextInterpolate(ctx.cancelButtonText);
    } }, directives: [ɵngcc2.Button, ɵngcc3.Icon], encapsulation: 2 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Searchbar, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: Config }, { type: Platform }, { type: ɵngcc0.ElementRef }, { type: Renderer }, { type: ɵngcc1.NgControl, decorators: [{
                type: Optional
            }] }]; }, { cancelButtonText: [{
            type: Input
        }], placeholder: [{
