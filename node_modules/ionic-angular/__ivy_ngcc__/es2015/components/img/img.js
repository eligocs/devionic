...
Img.ɵfac = function Img_Factory(t) { return new (t || Img)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(Platform), ɵngcc0.ɵɵdirectiveInject(Content, 8), ɵngcc0.ɵɵdirectiveInject(DomController)); };
Img.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: Img, selectors: [["ion-img"]], inputs: { alt: "alt", src: "src", bounds: "bounds", cache: "cache", width: "width", height: "height" }, decls: 1, vars: 0, template: function Img_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Img, [{
        type: Component,
        args: [{
                selector: 'ion-img',
                template: '<img>',
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: Renderer }, { type: Platform }, { type: Content, decorators: [{
                type: Optional
            }] }, { type: DomController }]; }, { alt: [{
            type: Input
        }], src: [{
            type: Input
        }], bounds: [{
