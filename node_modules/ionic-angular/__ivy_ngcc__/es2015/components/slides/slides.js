...
Slides.ɵfac = function Slides_Factory(t) { return new (t || Slides)(ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(Platform), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(ViewController, 8), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer)); };
Slides.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: Slides, selectors: [["ion-slides"]], inputs: { autoplay: "autoplay", control: "control", effect: "effect", direction: "direction", initialSlide: "initialSlide", loop: "loop", pager: "pager", dir: "dir", paginationType: "paginationType", parallax: "parallax", speed: "speed", zoom: "zoom", spaceBetween: "spaceBetween", slidesPerView: "slidesPerView", centeredSlides: "centeredSlides" }, outputs: { ionSlideWillChange: "ionSlideWillChange", ionSlideDidChange: "ionSlideDidChange", ionSlideDrag: "ionSlideDrag", ionSlideReachStart: "ionSlideReachStart", ionSlideReachEnd: "ionSlideReachEnd", ionSlideAutoplay: "ionSlideAutoplay", ionSlideAutoplayStart: "ionSlideAutoplayStart", ionSlideAutoplayStop: "ionSlideAutoplayStop", ionSlideNextStart: "ionSlideNextStart", ionSlidePrevStart: "ionSlidePrevStart", ionSlideNextEnd: "ionSlideNextEnd", ionSlidePrevEnd: "ionSlidePrevEnd", ionSlideTap: "ionSlideTap", ionSlideDoubleTap: "ionSlideDoubleTap" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature], ngContentSelectors: _c0, decls: 4, vars: 3, consts: [[1, "swiper-container"], [1, "swiper-wrapper"], [1, "swiper-pagination"]], template: function Slides_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵattribute("dir", ctx._rtl ? "rtl" : null);
        ɵngcc0.ɵɵadvance(3);
        ɵngcc0.ɵɵclassProp("hide", !ctx.pager);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Slides, [{
        type: Component,
        args: [{
                selector: 'ion-slides',
    ...
    }], function () { return [{ type: Config }, { type: Platform }, { type: ɵngcc0.NgZone }, { type: ViewController, decorators: [{
                type: Optional
            }] }, { type: ɵngcc0.ElementRef }, { type: Renderer }]; }, { ionSlideWillChange: [{
            type: Output
        }], ionSlideDidChange: [{
            type: Output
        }], ionSlideDrag: [{
