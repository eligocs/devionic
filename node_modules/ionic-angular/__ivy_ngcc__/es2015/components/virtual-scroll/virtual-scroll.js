...
VirtualScroll.ɵfac = function VirtualScroll_Factory(t) { return new (t || VirtualScroll)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.IterableDiffers), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(Content), ɵngcc0.ɵɵdirectiveInject(Platform), ɵngcc0.ɵɵdirectiveInject(ViewController), ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(DomController)); };
VirtualScroll.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: VirtualScroll, selectors: [["", "virtualScroll", ""]], contentQueries: function VirtualScroll_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._itmTmp = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._hdrTmp = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._ftrTmp = _t.first);
    } }, inputs: { bufferRatio: "bufferRatio", approxItemWidth: "approxItemWidth", approxHeaderWidth: "approxHeaderWidth", approxHeaderHeight: "approxHeaderHeight", approxFooterWidth: "approxFooterWidth", approxFooterHeight: "approxFooterHeight", virtualScroll: "virtualScroll", headerFn: "headerFn", footerFn: "footerFn", approxItemHeight: "approxItemHeight", virtualTrackBy: "virtualTrackBy" }, features: [ɵngcc0.ɵɵNgOnChangesFeature] });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(VirtualScroll, [{
        type: Directive,
        args: [{
                selector: '[virtualScroll]'
            }]
    }], function () { return [{ type: ɵngcc0.IterableDiffers }, { type: ɵngcc0.ElementRef }, { type: Renderer }, { type: ɵngcc0.NgZone }, { type: ɵngcc0.ChangeDetectorRef }, { type: Content }, { type: Platform }, { type: ViewController }, { type: Config }, { type: DomController }]; }, { bufferRatio: [{
            type: Input
        }], approxItemWidth: [{
            type: Input
        }], approxHeaderWidth: [{
