...
import * as ɵngcc4 from './picker-column';

function PickerCmp_div_3_Template(rf, ctx) { if (rf & 1) {
    const _r4 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 8);
    ɵngcc0.ɵɵelementStart(1, "button", 9);
    ɵngcc0.ɵɵlistener("click", function PickerCmp_div_3_Template_button_click_1_listener() { ɵngcc0.ɵɵrestoreView(_r4); const b_r2 = ctx.$implicit; const ctx_r3 = ɵngcc0.ɵɵnextContext(); return ctx_r3.btnClick(b_r2); });
    ɵngcc0.ɵɵtext(2);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function PickerCmp_div_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("ionChange", function PickerCmp_div_6_Template_div_ionChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r7); const ctx_r6 = ɵngcc0.ɵɵnextContext(); return ctx_r6._colChange($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
PickerCmp.ɵfac = function PickerCmp_Factory(t) { return new (t || PickerCmp)(ɵngcc0.ɵɵdirectiveInject(ViewController), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(GestureController), ɵngcc0.ɵɵdirectiveInject(NavParams), ɵngcc0.ɵɵdirectiveInject(Renderer)); };
PickerCmp.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: PickerCmp, selectors: [["ion-picker-cmp"]], viewQuery: function PickerCmp_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(PickerColumnCmp, true);
    } if (rf & 2) {
        var _t;
    ...
    } }, directives: [ɵngcc1.Backdrop, ɵngcc2.NgForOf, ɵngcc2.NgClass, ɵngcc3.Button, ɵngcc4.PickerColumnCmp], encapsulation: 2 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PickerCmp, [{
        type: Component,
        args: [{
  ...
  `,
    ...
    }], function () { return [{ type: ViewController }, { type: ɵngcc0.ElementRef }, { type: Config }, { type: GestureController }, { type: NavParams }, { type: Renderer }]; }, { _keyUp: [{
            type: HostListener,
