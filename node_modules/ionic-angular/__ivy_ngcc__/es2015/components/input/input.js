...
const _c0 = ["textInput"];
function TextInput_input_0_Template(rf, ctx) { if (rf & 1) {
    const _r6 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "input", 4, 5);
    ɵngcc0.ɵɵlistener("input", function TextInput_input_0_Template_input_input_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r6); const ctx_r5 = ɵngcc0.ɵɵnextContext(); return ctx_r5.onInput($event); })("blur", function TextInput_input_0_Template_input_blur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r6); const ctx_r7 = ɵngcc0.ɵɵnextContext(); return ctx_r7.onBlur($event); })("focus", function TextInput_input_0_Template_input_focus_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r6); const ctx_r8 = ɵngcc0.ɵɵnextContext(); return ctx_r8.onFocus($event); })("keydown", function TextInput_input_0_Template_input_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r6); const ctx_r9 = ɵngcc0.ɵɵnextContext(); return ctx_r9.onKeydown($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r0 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", "text-input-" + ctx_r0._mode)("type", ctx_r0._type)("placeholder", ctx_r0.placeholder)("disabled", ctx_r0._disabled)("readonly", ctx_r0._readonly);
    ɵngcc0.ɵɵattribute("aria-labelledby", ctx_r0._labelId)("min", ctx_r0.min)("max", ctx_r0.max)("step", ctx_r0.step)("autocomplete", ctx_r0.autocomplete)("autocorrect", ctx_r0.autocorrect);
} }
function TextInput_textarea_1_Template(rf, ctx) { if (rf & 1) {
    const _r12 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "textarea", 6, 5);
    ɵngcc0.ɵɵlistener("input", function TextInput_textarea_1_Template_textarea_input_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r12); const ctx_r11 = ɵngcc0.ɵɵnextContext(); return ctx_r11.onInput($event); })("blur", function TextInput_textarea_1_Template_textarea_blur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r12); const ctx_r13 = ɵngcc0.ɵɵnextContext(); return ctx_r13.onBlur($event); })("focus", function TextInput_textarea_1_Template_textarea_focus_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r12); const ctx_r14 = ɵngcc0.ɵɵnextContext(); return ctx_r14.onFocus($event); })("keydown", function TextInput_textarea_1_Template_textarea_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r12); const ctx_r15 = ɵngcc0.ɵɵnextContext(); return ctx_r15.onKeydown($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", "text-input-" + ctx_r1._mode)("placeholder", ctx_r1.placeholder)("disabled", ctx_r1._disabled)("readonly", ctx_r1._readonly);
    ɵngcc0.ɵɵattribute("aria-labelledby", ctx_r1._labelId)("autocomplete", ctx_r1.autocomplete)("autocorrect", ctx_r1.autocorrect);
} }
function TextInput_button_2_Template(rf, ctx) { if (rf & 1) {
    const _r17 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "button", 7);
    ɵngcc0.ɵɵlistener("click", function TextInput_button_2_Template_button_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r17); const ctx_r16 = ɵngcc0.ɵɵnextContext(); return ctx_r16.clearTextInput($event); })("mousedown", function TextInput_button_2_Template_button_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r17); const ctx_r18 = ɵngcc0.ɵɵnextContext(); return ctx_r18.clearTextInput($event); });
    ɵngcc0.ɵɵelementEnd();
} }
function TextInput_div_3_Template(rf, ctx) { if (rf & 1) {
    const _r20 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 8);
    ɵngcc0.ɵɵlistener("touchstart", function TextInput_div_3_Template_div_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r20); const ctx_r19 = ɵngcc0.ɵɵnextContext(); return ctx_r19._pointerStart($event); })("touchend", function TextInput_div_3_Template_div_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r20); const ctx_r21 = ɵngcc0.ɵɵnextContext(); return ctx_r21._pointerEnd($event); })("mousedown", function TextInput_div_3_Template_div_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r20); const ctx_r22 = ɵngcc0.ɵɵnextContext(); return ctx_r22._pointerStart($event); })("mouseup", function TextInput_div_3_Template_div_mouseup_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r20); const ctx_r23 = ɵngcc0.ɵɵnextContext(); return ctx_r23._pointerEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} }
...
TextInput.ɵfac = function TextInput_Factory(t) { return new (t || TextInput)(ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(Platform), ɵngcc0.ɵɵdirectiveInject(Form), ɵngcc0.ɵɵdirectiveInject(App), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(Content, 8), ɵngcc0.ɵɵdirectiveInject(Item, 8), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.NgControl, 8), ɵngcc0.ɵɵdirectiveInject(DomController)); };
TextInput.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: TextInput, selectors: [["ion-input"], ["ion-textarea"]], viewQuery: function TextInput_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, true, ElementRef);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._native = _t.first);
    } }, inputs: { value: "value", autocomplete: "autocomplete", autocorrect: "autocorrect", placeholder: "placeholder", min: "min", max: "max", step: "step", clearInput: "clearInput", type: "type", readonly: "readonly", clearOnEdit: "clearOnEdit" }, outputs: { input: "input", blur: "blur", focus: "focus" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature], decls: 4, vars: 4, consts: [["class", "text-input", "dir", "auto", 3, "ngClass", "type", "placeholder", "disabled", "readonly", "input", "blur", "focus", "keydown", 4, "ngIf"], ["class", "text-input", 3, "ngClass", "placeholder", "disabled", "readonly", "input", "blur", "focus", "keydown", 4, "ngIf"], ["ion-button", "", "clear", "", "class", "text-input-clear-icon", "type", "button", "tabindex", "-1", 3, "click", "mousedown", 4, "ngIf"], ["class", "input-cover", 3, "touchstart", "touchend", "mousedown", "mouseup", 4, "ngIf"], ["dir", "auto", 1, "text-input", 3, "ngClass", "type", "placeholder", "disabled", "readonly", "input", "blur", "focus", "keydown"], ["textInput", ""], [1, "text-input", 3, "ngClass", "placeholder", "disabled", "readonly", "input", "blur", "focus", "keydown"], ["ion-button", "", "clear", "", "type", "button", "tabindex", "-1", 1, "text-input-clear-icon", 3, "click", "mousedown"], [1, "input-cover", 3, "touchstart", "touchend", "mousedown", "mouseup"]], template: function TextInput_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, TextInput_input_0_Template, 2, 11, "input", 0);
        ɵngcc0.ɵɵtemplate(1, TextInput_textarea_1_Template, 2, 7, "textarea", 1);
        ɵngcc0.ɵɵtemplate(2, TextInput_button_2_Template, 1, 0, "button", 2);
        ɵngcc0.ɵɵtemplate(3, TextInput_div_3_Template, 1, 0, "div", 3);
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("ngIf", !ctx._isTextarea);
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngIf", ctx._isTextarea);
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngIf", ctx._clearInput);
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngIf", ctx._useAssist);
    } }, directives: [ɵngcc2.NgIf, ɵngcc2.NgClass, ɵngcc3.Button], encapsulation: 2, changeDetection: 0 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(TextInput, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: Config }, { type: Platform }, { type: Form }, { type: App }, { type: ɵngcc0.ElementRef }, { type: Renderer }, { type: Content, decorators: [{
                type: Optional
            }] }, { type: Item, decorators: [{
                type: Optional
            }] }, { type: ɵngcc1.NgControl, decorators: [{
                type: Optional
            }] }, { type: DomController }]; }, { autocomplete: [{
            type: Input
        }], autocorrect: [{
            type: Input
        }], placeholder: [{
