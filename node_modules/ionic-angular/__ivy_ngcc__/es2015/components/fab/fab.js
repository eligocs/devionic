...
FabButton.ɵfac = function FabButton_Factory(t) { return new (t || FabButton)(ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer)); };
FabButton.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: FabButton, selectors: [["", "ion-fab", ""]], features: [ɵngcc0.ɵɵInheritDefinitionFeature], attrs: _c0, ngContentSelectors: _c1, decls: 4, vars: 0, consts: [["name", "close", 1, "fab-close-icon"], [1, "button-inner"], [1, "button-effect"]], template: function FabButton_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [ɵngcc1.Icon], encapsulation: 2, changeDetection: 0 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(FabButton, [{
        type: Component,
        args: [{
                selector: '[ion-fab]',
    ...
    }], function () { return [{ type: Config }, { type: ɵngcc0.ElementRef }, { type: Renderer }]; }, null); })();
