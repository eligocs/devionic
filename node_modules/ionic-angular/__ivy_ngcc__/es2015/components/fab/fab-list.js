...
FabList.ɵfac = function FabList_Factory(t) { return new (t || FabList)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(Platform)); };
FabList.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: FabList, selectors: [["ion-fab-list"]], contentQueries: function FabList_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, FabButton, false);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._setbuttons = _t);
    } } });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(FabList, [{
        type: Directive,
        args: [{
                selector: 'ion-fab-list'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: Renderer }, { type: Config }, { type: Platform }]; }, { _setbuttons: [{
