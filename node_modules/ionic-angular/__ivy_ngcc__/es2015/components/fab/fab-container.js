...
FabContainer.ɵfac = function FabContainer_Factory(t) { return new (t || FabContainer)(ɵngcc0.ɵɵdirectiveInject(Platform)); };
FabContainer.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: FabContainer, selectors: [["ion-fab"]], contentQueries: function FabContainer_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, FabButton, true);
        ɵngcc0.ɵɵcontentQuery(dirIndex, FabList, false);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._mainButton = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._fabLists = _t);
    } }, ngContentSelectors: _c0, decls: 1, vars: 0, template: function FabContainer_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(FabContainer, [{
        type: Component,
        args: [{
                selector: 'ion-fab',
                template: '<ng-content></ng-content>'
            }]
    }], function () { return [{ type: Platform }]; }, { _mainButton: [{
            type: ContentChild,
            args: [FabButton]
        }], _fabLists: [{
