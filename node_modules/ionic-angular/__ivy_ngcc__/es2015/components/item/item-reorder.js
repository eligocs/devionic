...
ItemReorder.ɵfac = function ItemReorder_Factory(t) { return new (t || ItemReorder)(ɵngcc0.ɵɵdirectiveInject(Platform), ɵngcc0.ɵɵdirectiveInject(DomController), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(Content, 8)); };
ItemReorder.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ItemReorder, selectors: [["ion-list", "reorder", ""], ["ion-item-group", "reorder", ""]], hostVars: 6, hostBindings: function ItemReorder_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵclassProp("reorder-enabled", ctx._enableReorder)("reorder-visible", ctx._visibleReorder)("reorder-side-start", ctx._isStart);
    } }, inputs: { side: "side", reorder: "reorder" }, outputs: { ionItemReorder: "ionItemReorder" } });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ItemReorder, [{
        type: Directive,
        args: [{
    ...
    }], function () { return [{ type: Platform }, { type: DomController }, { type: ɵngcc0.ElementRef }, { type: Renderer }, { type: ɵngcc0.NgZone }, { type: Content, decorators: [{
                type: Optional
            }] }]; }, { ionItemReorder: [{
            type: Output
        }], side: [{
