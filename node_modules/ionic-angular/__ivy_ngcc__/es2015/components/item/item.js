...
import * as ɵngcc2 from '../label/label';
import * as ɵngcc3 from './reorder';

function Item_ion_label_4_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelementStart(0, "ion-label");
    ɵngcc0.ɵɵprojection(1, 4);
    ɵngcc0.ɵɵelementEnd();
} }
function Item_ion_reorder_7_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "ion-reorder");
} }
const _c0 = [[["", "item-start", ""], ["", "item-left", ""], ["ion-checkbox", 3, "item-end", "", 3, "item-right", ""]], [["ion-label"]], [["ion-select"], ["ion-input"], ["ion-textarea"], ["ion-datetime"], ["ion-range"], ["", "item-content", ""]], [["", "item-end", ""], ["", "item-right", ""], ["ion-radio"], ["ion-toggle"]], "*"];
const _c1 = ["[item-start],[item-left],ion-checkbox:not([item-end]):not([item-right])", "ion-label", "ion-select,ion-input,ion-textarea,ion-datetime,ion-range,[item-content]", "[item-end],[item-right],ion-radio,ion-toggle", "*"];
...
Item.ɵfac = function Item_Factory(t) { return new (t || Item)(ɵngcc0.ɵɵdirectiveInject(Form), ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(ItemReorder, 8)); };
Item.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: Item, selectors: [["ion-list-header"], ["ion-item"], ["", "ion-item", ""], ["ion-item-divider"]], contentQueries: function Item_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, Label, true);
        ɵngcc0.ɵɵcontentQuery(dirIndex, Button, false);
        ɵngcc0.ɵɵcontentQuery(dirIndex, Icon, false);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.contentLabel = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._buttons = _t);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._icons = _t);
    } }, viewQuery: function Item_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(Label, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.viewLabel = _t.first);
    } }, hostAttrs: [1, "item"], features: [ɵngcc0.ɵɵInheritDefinitionFeature], ngContentSelectors: _c1, decls: 9, vars: 2, consts: [[1, "item-inner"], [1, "input-wrapper"], [4, "ngIf"], [1, "button-effect"]], template: function Item_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef(_c0);
        ɵngcc0.ɵɵprojection(0);
        ɵngcc0.ɵɵelementStart(1, "div", 0);
        ɵngcc0.ɵɵelementStart(2, "div", 1);
        ɵngcc0.ɵɵprojection(3, 1);
        ɵngcc0.ɵɵtemplate(4, Item_ion_label_4_Template, 2, 0, "ion-label", 2);
        ɵngcc0.ɵɵprojection(5, 2);
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵprojection(6, 3);
        ɵngcc0.ɵɵtemplate(7, Item_ion_reorder_7_Template, 1, 0, "ion-reorder", 2);
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelement(8, "div", 3);
    } if (rf & 2) {
        ɵngcc0.ɵɵadvance(4);
        ɵngcc0.ɵɵproperty("ngIf", ctx._viewLabel);
        ɵngcc0.ɵɵadvance(3);
        ɵngcc0.ɵɵproperty("ngIf", ctx._hasReorder);
    } }, directives: [ɵngcc1.NgIf, ɵngcc2.Label, ɵngcc3.Reorder], encapsulation: 2, changeDetection: 0 });
/** @nocollapse */
Item.ctorParameters = () => [
    { type: Form, },
    { type: Config, },
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Item, [{
    ...
    }], function () { return [{ type: Form }, { type: Config }, { type: ɵngcc0.ElementRef }, { type: Renderer }, { type: ItemReorder, decorators: [{
                type: Optional
            }] }]; }, { contentLabel: [{
            type: ContentChild,
            args: [Label]
