...
const _c0 = [[["ion-item"], ["", "ion-item", ""]], [["ion-item-options"]]];
const _c1 = ["ion-item,[ion-item]", "ion-item-options"];
...
ItemSliding.ɵfac = function ItemSliding_Factory(t) { return new (t || ItemSliding)(ɵngcc0.ɵɵdirectiveInject(List, 8), ɵngcc0.ɵɵdirectiveInject(Platform), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone)); };
ItemSliding.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ItemSliding, selectors: [["ion-item-sliding"]], contentQueries: function ItemSliding_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, Item, true);
        ɵngcc0.ɵɵcontentQuery(dirIndex, ItemOptions, false);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.item = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._itemOptions = _t);
    } }, outputs: { ionDrag: "ionDrag" }, ngContentSelectors: _c1, decls: 2, vars: 0, template: function ItemSliding_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ItemSliding, [{
        type: Component,
        args: [{
  ...
  `,
    ...
    }], function () { return [{ type: List, decorators: [{
                type: Optional
            }] }, { type: Platform }, { type: Renderer }, { type: ɵngcc0.ElementRef }, { type: ɵngcc0.NgZone }]; }, { ionDrag: [{
            type: Output
        }], _itemOptions: [{
            type: ContentChildren,
            args: [forwardRef(() => ItemOptions)]
        }], item: [{
            type: ContentChild,
            args: [Item]
        }] }); })();
