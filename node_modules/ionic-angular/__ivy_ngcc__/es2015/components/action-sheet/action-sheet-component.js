...
function ActionSheetCmp_button_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ActionSheetCmp_button_6_Template_button_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r8); const b_r4 = ctx.$implicit; const ctx_r7 = ɵngcc0.ɵɵnextContext(); return ctx_r7.click(b_r4); });
...
function ActionSheetCmp_div_7_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ActionSheetCmp_div_7_Template_button_click_1_listener() { ɵngcc0.ɵɵrestoreView(_r11); const ctx_r10 = ɵngcc0.ɵɵnextContext(); return ctx_r10.click(ctx_r10.cancelButton); });
...
ActionSheetCmp.ɵfac = function ActionSheetCmp_Factory(t) { return new (t || ActionSheetCmp)(ɵngcc0.ɵɵdirectiveInject(ViewController), ɵngcc0.ɵɵdirectiveInject(Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(GestureController), ɵngcc0.ɵɵdirectiveInject(NavParams), ɵngcc0.ɵɵdirectiveInject(Renderer)); };
ActionSheetCmp.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ActionSheetCmp, selectors: [["ion-action-sheet"]], hostAttrs: ["role", "dialog"], hostVars: 2, hostBindings: function ActionSheetCmp_HostBindings(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [ɵngcc1.Backdrop, ɵngcc2.NgIf, ɵngcc2.NgForOf, ɵngcc3.Button, ɵngcc2.NgClass, ɵngcc4.Icon], encapsulation: 2 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ActionSheetCmp, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: ViewController }, { type: Config }, { type: ɵngcc0.ElementRef }, { type: GestureController }, { type: NavParams }, { type: Renderer }]; }, { keyUp: [{
            type: HostListener,
