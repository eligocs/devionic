...
Option.ɵfac = function Option_Factory(t) { return new (t || Option)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
Option.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: Option, selectors: [["ion-option"]], inputs: { disabled: "disabled", selected: "selected", value: "value" }, outputs: { ionSelect: "ionSelect" } });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Option, [{
        type: Directive,
        args: [{
                selector: 'ion-option'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }]; }, { ionSelect: [{
            type: Output
        }], disabled: [{
            type: Input
        }], selected: [{
