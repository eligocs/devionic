...
import * as ɵngcc2 from '../spinner/spinner';
...
InfiniteScrollContent.ɵfac = function InfiniteScrollContent_Factory(t) { return new (t || InfiniteScrollContent)(ɵngcc0.ɵɵdirectiveInject(InfiniteScroll), ɵngcc0.ɵɵdirectiveInject(Config)); };
InfiniteScrollContent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: InfiniteScrollContent, selectors: [["ion-infinite-scroll-content"]], hostVars: 1, hostBindings: function InfiniteScrollContent_HostBindings(rf, ctx) { if (rf & 2) {
    ...
    } }, directives: [ɵngcc1.NgIf, ɵngcc2.Spinner], encapsulation: 2 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(InfiniteScrollContent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: InfiniteScroll }, { type: Config }]; }, { loadingSpinner: [{
            type: Input
        }], loadingText: [{
            type: Input
        }] }); })();
