...
ModuleLoader.ɵfac = function ModuleLoader_Factory(t) { return new (t || ModuleLoader)(ɵngcc0.ɵɵinject(NgModuleLoader), ɵngcc0.ɵɵinject(ɵngcc0.Injector)); };
ModuleLoader.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ModuleLoader, factory: ModuleLoader.ɵfac });
/** @nocollapse */
ModuleLoader.ctorParameters = () => [
    { type: NgModuleLoader, },
    { type: Injector, },
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ModuleLoader, [{
        type: Injectable
    }], function () { return [{ type: NgModuleLoader }, { type: ɵngcc0.Injector }]; }, null); })();
const SPLITTER = '#';
/**
 * @hidden
 */
